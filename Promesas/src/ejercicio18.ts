...
function ejecutarTarea(nombre: string, tiempo: number): Promise<string> {
...
function* tareasGenerator(): Generator<string> {
  yield "Tarea 1";
  yield "Tarea 2";
  yield "Tarea 3";
}
